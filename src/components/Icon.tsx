...
const ICONS: Record<string, (color?: string, size?: number) => string> = {
  ...
  file: icon(
    '0 0 24 24',
    '<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/>',
  ),
  app: icon(
    '0 0 24 24',
  ...
  calculator: icon(
    '0 0 24 24',
    '<rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="7" x2="7" y1="12" y2="12"/><line x1="12" x2="12" y1="12" y2="12"/><line x1="17" x2="17" y1="12" y2="12"/><line x1="7" x2="7" y1="17" y2="17"/><line x1="12" x2="12" y1="17" y2="17"/><line x1="17" x2="17" y1="17" y2="17"/>',
  ),
  system: icon(
    '0 0 24 24',
