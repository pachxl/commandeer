...
| `src/vite-env.d.ts` | Vite asset-module type declarations                                    | [`frontend.md`](frontend.md)                                         |
...
| `src/hooks/usePaletteWindowSize.ts`       | Measures and serializes newest-only native palette geometry          | [`frontend.md`](frontend.md), [`platforms.md`](platforms.md) |
| `src/hooks/usePaletteWindowSize.test.tsx` | Compact/expanded sizing, scaling, Wayland, and cleanup regressions   | [`testing.md`](testing.md)                                   |
| `src/hooks/useOnixOptics.ts`              | Event-driven WebGL optics and accessible CSS fallback                | [`frontend.md`](frontend.md), [`testing.md`](testing.md)     |
| `src/hooks/useOnixOptics.test.ts`         | Optical resolution and shader-geometry regressions                   | [`testing.md`](testing.md)                                   |
...
| `src/components/OnixOpticalShell.tsx`      | Black Water shell, WebGL canvas, and CSS fallback                       | [`frontend.md`](frontend.md), [`testing.md`](testing.md)           |
| `src/components/OnixOpticalShell.test.tsx` | Optical fallback and accessibility-policy regressions                   | [`testing.md`](testing.md)                                         |
...
| `src/components/ActionPanel.tsx`           | Ctrl+K action/submenu UI and active action lens                         | [`commands.md`](commands.md), [`frontend.md`](frontend.md)         |
...
| `src/components/Footer.test.tsx`           | Bundled navigation-logo and invalid-icon regressions                    | [`testing.md`](testing.md)                                         |
...
| `src/components/SelectionLens.tsx`         | Single moving selection geometry for list/grid/action surfaces          | [`frontend.md`](frontend.md)                                       |
| `src/components/SelectionLens.test.tsx`    | Selection geometry, resize, and inactive-surface regressions            | [`testing.md`](testing.md)                                         |
| `src/components/SearchInput.tsx`           | Query field and live preview                                            | [`frontend.md`](frontend.md)                                       |
| `src/components/SearchInput.test.tsx`      | Compact hotkey and pointer-engagement regressions                       | [`testing.md`](testing.md)                                         |
...
| `src/components/SystemStats.test.tsx`      | Semantic utilization colours and accessibility regressions              | [`testing.md`](testing.md)                                         |
...
| `src/lib/styles.test.ts`           | Style application, events, and Default cleanup   | [`testing.md`](testing.md)                               |
...
| `src/lib/onixPresentation.ts`      | Sticky compact-to-panel Onix session rules       | [`frontend.md`](frontend.md)                             |
| `src/lib/onixPresentation.test.ts` | Onix presentation/session transition regressions | [`testing.md`](testing.md)                               |
...
| `src-tauri/src/commands/palette_surface.rs`  | Native Onix material, clipping, and corner geometry    | [`frontend.md`](frontend.md), [`platforms.md`](platforms.md), [`testing.md`](testing.md) |
...
| `src-tauri/src/commands/window.rs`           | Native transparency and top-fixed macOS palette resize | [`configuration.md`](configuration.md), [`platforms.md`](platforms.md)                   |
